            ...
            <div className="container">
                ...
                <div className="group/projects relative" ref={containerRef}>
                    {selectedProject !== null && (
                        <div
                            className="max-md:hidden rounded-xl border  border-primary absolute right-0 top-0 z-[1] pointer-events-none w-[200px] xl:w-[350px] aspect-[4/5] overflow-hidden opacity-0"
                            ref={imageContainer}
                        >
